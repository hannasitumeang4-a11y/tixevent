<aside class="w-56 bg-gray-900 text-white p-4">
    ...
    <nav class="space-y-2">
        ...
        <a href="{{ route('admin.reviewmanage') }}" class="block px-3 py-2 rounded hover:bg-gray-700">Review</a>
        <a href="{{ route('admin.report') }}" class="block px-3 py-2 rounded hover:bg-gray-700">Laporan</a>
